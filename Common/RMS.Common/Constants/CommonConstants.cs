...
namespace RMS.Common.Constants
{
    public static class CommonConstants
    {
        ...
        //public const string WhizibleGroupEmailId = "Whizible.Support.Team@northgateps.com";
       ...
       // public const string CFOEmailIDs = "kedar.barve@northgateps.com";
        ...
        public const string SendMailToAll = "Send Mail To All";
        ...
        public const int DefaultFlagTwo = 2;
        ...
        public const string ResultPartial = "ResultPartial";        
        public const string ResultStyle = "ResultStyle";        
        ...
        public const string ViewSubmitNominationForTraining = "ViewSubmitNominationForTraining";
        ...
        public const string _PartialViewEmployeeTrainingNominationDetails = "_EmployeeTrainingNominationDetails";
        //Harsha Issue Id-59073 - End
        public const string ConfirmTrainingNomination = "ConfirmTrainingNomination";
        public const string _PartialVIewEmployeeDetail = "_AddEmployeeGrid";
        public const string _PartialVIewNominationEmployeeRecord = "_ViewNominationEmployeeRecordl";
        public const string ViewAttendance = "ViewAttendance";
        public const string SetAttendance = "SetAttendance";
        public const string PrintAttendance = "PrintAttendance";
        public const string _PartialVIewEmployeeDetailDialog = "_ViewEmployeeDetail";
        public const string EmailConfigUrl = "EmailConfigUrl"; 
        public const string RMGroupName = "RMGroup";
        public const string RaiseTrainingRequest = "RaiseTrainingRequest";
        //public const int TrainingStatusDeleted = 1241;
        //public const int ApproveRejectID = 1415; 
        public static KeyValuePair<int, string> selectDefault = new KeyValuePair<int, string>(0, "select");
        public const string _PartialViewTrainingDetail = "_ViewNominationTrainingDetail"; 
        public const string PartialViewTrainingGrid = "_viewTrainingGrid";
        public const string PartialViewTrainingEffectiveness = "ViewTrainingEffectiveness";
        public const string MyTrainingView = "MyTraining";
        public const string TechnicalTrainingText = "Technical";
        public const string SoftSkillTrainingText = "Soft Skill";
        public const string MyTrainingGridView = "_MyTrainingsGrid";
        

        public static string CommonRepository = "CommonRepository";
        public const string PreTrainingRating = "Pre Training Rating";
        public const string Priority = "Priority";
        public const string Message = "Message";

        private const string StatusName = "StatusName";
        public const string ApproveRejectTrainingRequest     = "ApproveRejectTrainingRequest";
        public const string ApproveRejectTrainingRequestGrid = "ApproveRejectTrainingRequestGrid";
        public const string partialView_ApproveRejectGrid = "_approveRejectTrainingRequest";
        public const string TrainingRejected="Training requisition rejected.";
        public const string TrainingApproved= "Training requisition approved.";
        public const string Seminarrejected="Seminar request rejected.";
        public const string SeminarApproved = "Seminar request approved.";
        public const string NominationConfirmationPage = "confirmnomination";
        public const string NominationConfirmationRoute = "/Nomination/ViewConfirmNominationForTraining";
        //Harsha Issue Id-59073 - Start
        //Description- Training : Create emp Nominated page so that emp can view they nomination. Change confirmation email body
        public const string ViewEmployeeTrainingNominationURL = "nomination/viewnominationforemployeetraining?courseId=";
        //Harsha Issue Id-59073 - End
        public const string NominationController = "Nomination";
        public const int SelfNomination = 1913;
        public const int ManagerNomination = 1914;
        public const int RMONomination = 1915;
        public const string NominationConfirmed = "NominationConfirmed";
        public const string NominationSubmited = "NominationSubmited";
        public const string NominationSaved = "NominationSaved";
        // Harsha Issue Id-59072 - Start
        // Description: Training : provision to Re-approve the  Rejected Nomination for the courses
        public const string NominationRejected = "NominationRejected";
        // Harsha Issue Id-59072 - End
        public const string ShowConfirmNominationEmployeeGrid = "ShowConfirmNominationEmployeeGrid";
        public const string CourseContentView = "_FileHelperView";                

        public const string AdminRole = "admin";
        public const string UserRole = "user";
        public const string ManagerRole = "manager";
        //public const string HRHeadRole = "hrhead";
        public const string LineManagerEMailID = "LineManagerEMailID";
        public const string NominatingManagerEmailID = "NominatingManagerEmailID";
        public const string PostRatingDueDate = "PostRatingDueDate";
        public const string EmployeeEmailId = "EmployeeEmailId";
        public const string Assessment = "Assessment";
        public const string PostTrainingRating = "PostTrainingRating";
        public const string OldRMSBaseUrl = "OldRMSBaseUrl";
        public const string FeedbackLinkRoute = "/Feedback/FeedbackForm";
        public const string ViewTechnicalTrainingRequestRoute = "/Training/ViewTechnicalTrainingRequest";
        public const string TrainingEffectivenessRoute = "/Nomination/TrainingEffectiveness";
        public const string EmpID = "EmpID";
    #endregion
        //Ishwar Patil Training Module : 23/03/2013 : End

        public const string MessageStyleSuccess = "MessageStyleSuccess";
        public const string MessageStyleFail = "MessageStyleFail";
        ...
        #endregion
        #region Training Course Constants

        public const string TrainingMode = "TrainingMode";
        public const string NominationType = "NominationType";        
        public const string PaymentMade = "PaymentMade";
        public const string TrainingEffectiveness = "TrainingEffectiveness";
        public const string PaymentMode = "PaymentMode";
        public const string ViewTrainingCourseGrid = "_CourseGrid";
        public const int InternalTrainer = 1909;
        public const int ExternalTrainer = 1910;
        public const string RaiseRequestGrid = "_RaiseRequestGrid";
        public const string EditMode = "EditMode";
        public const string AddMode = "AddMode";
        public const string ViewMode = "ViewMode";
        public const int PaymentMadeYes = 1911;
        public const int PaymentMadeNo = 1912;
        public const string FileHelperView = "_FileHelperView";
        public const int PreTrainingEffectiveness = 1901;
        public const int ApprovedTraining = 1233;
        public const int CourseCreatedTraining = 1894;
        public const string CourseContentDir = "RMS_Files/CourseContent";
        public const string CourseDARDir = "RMS_Files/DARForm";
        public const string CourseTrainerDir = "RMS_Files/TrainerProfile";
        public const string CourseInvoiceDir = "RMS_Files/InvoiceForm";
        //public const string ActiveTrainingIDs = "1232,1233,1897,1896,1895,1894";
        //public const int ClosedTrainingID = 1235;
        //public const int CancelledTrainingID = 1236;
        public const string InviteNominationRoute = "/nomination/viewsubmitnominationfortraining";
        #endregion Training Course Constants

        #region Assessment Module Constants
        public const string AssessmentQuestionImgPath = "AssessmentQuestionImgPath";
        public const string AssessmentAnswerImgPath = "AssessmentAnswerImgPath";
        #endregion

        #region TrainingPlan
        public const string AddTrainingPlan = "AddTrainingPlan";
        public const string _PartialViewAddPlan = "_AddPlan";
        public const string _ViewTrainingPlan = "_ViewTrainingPlan";
        #endregion

        public const string ViewEmployeeTillBilledView = "EmployeeTillBilled";
        public const string _PartialViewAListEmployeeTillBilled = "_ListEmployeeTillBilled";

        public const string EmailIdOfKSSBA = "EmailIdOfKSSBA"; 
        public const string EmailIdOfKSSUsability = "EmailIdOfKSSUsability"; 
        public const string EmailIdOfKSSTechTesting = "EmailIdOfKSSTechTesting";

        public const string EmailIdOfRaveIndia = "rave.india@northgateps.com";

        public const string ViewTrainingModule = "TrainingModule";


        #region RMS Admin 
                
        public const string PartialListMasters = "_ListMasters";

        public const string PartialAddMaster = "_AddMaster";



        public const string BudgetFilters = "_Filters";
        public const string PartialListCostCodes = "_ListCostCodes";
        ...
        public const string BusinessVerticals = "Business Vertical";
        

        public const string FeedbackCompleted = "FeedbackCompleted";
        public const string _PartialIP = "_ListInterviewPanel";

        public const string ProficiencyLevel = "Proficiency Level";
    }
}
